        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <!-- Details Modal -->
                    ...
                    <form id="itemForm" action="" method='Post' enctype="multipart/form-data" class="w-full max-w-lg">
                    @csrf
                ...
                <div class="modal fade bd-example-modal-md " id="edititemsmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
                    <div class="modal-dialog modal-md" role="document">
                        ...
                        <div class="modal-body d-flex justify-content-center">
                    <form id="edititemForm" action="" method='Post' enctype="multipart/form-data" class="w-full max-w-lg">
                    @csrf
