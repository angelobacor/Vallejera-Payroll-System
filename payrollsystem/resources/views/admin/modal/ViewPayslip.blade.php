...
<div id="view-payslip" style="display: none;" tabindex="-1" aria-hidden="true" class="items-center modal hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
    ...
    <!-- Logo on the right -->
    <div class="logo-wrapper" style="width: 60px; height: 60px; overflow: hidden; border-radius: 10%;">
        <img src="{{ asset('logo/logo.jpg') }}" alt="Logo" class="w-auto h-full object-contain" />
    </div>
</div>
            ...
            <div class="p-4 md:p-5">
                ...
                <div class="grid grid-cols-3 gap-4 items-center mb-6">
                    ...
                    <div class="flex items-center">
                        <div class="w-16 h-16 rounded-full overflow-hidden mr-4">
                            <img name="usr_img" alt="Profile Picture" class="w-full h-full object-cover rounded-full">
                        </div>
                ...
                <div class="mb-6">
                    <div class="grid gap-4">
                        ...
                        <div class="flex justify-between text-gray-700 text-xs font-medium">
                            <span>Deductions list:</span>
                            <span name='none' class="text-blue-500">---------</span>
                        </div>
                        <div class="flex justify-between text-gray-700 text-xs font-medium">
                            <span>Tax Income:</span>
                            <span name='taxincome' class="text-blue-500">₱3,500.00</span>
                        </div>

                        <div id="deductions_container"></div>
