...
<div id="editemstat" class="fixed inset-0 bg-gray-800 bg-opacity-60 flex items-center justify-center hidden z-50">
    <div class="bg-white p-4 rounded-lg shadow-lg relative w-full max-w-md">
        ...
        <h2 class="text-2xl font-semibold mb-4 text-gray-800">Edit Employment Status</h2>
        
        <form class="space-y-4" method="POST" action="{{route('edit_employment_status')}}">
            @csrf
            ...
            <div class="flex-1">
                    <label for="employment-status" class="block text-sm font-medium text-gray-700">Status</label>
            ...
            <div class="flex justify-end mt-4 gap-2">
                <button type="button" onclick="closeEditmployementstat()" class="bg-gray-200 text-gray-700 px-4 py-2 rounded-lg hover:bg-gray-300 focus:outline-none focus:ring-2 focus:ring-gray-500">Cancel</button>
