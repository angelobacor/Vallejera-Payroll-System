...
<div class="h-full ml-14 mt-14 mb-5 md:ml-64">
    ...
    <button class="text-gray-600 focus:outline-none">
        ...
        @foreach (['Created', 'Status'] as $filter)
            <button 
...
<div class="overflow-x-auto mt-6 ml-10 mr-10">
        <table class="min-w-full divide-y divide-gray-200">
            <thead class="bg-gray-50">
                <tr>
                    ...
                    <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Parent Departmen</th>
    ...
    <button onclick = "editdept()" id="editButton" class="hidden absolute top-0 right-0 mt-8 mr-2 bg-blue-500 text-white px-3 py-1 rounded" onclick="editItem()">
        Edit
    </button>
