...
@section('content')
<!-- @includenotfound('admin.employees.Modal.CreatedModal') -->
@include('admin.Administration.Modal.type')
@include('admin.Administration.Modal.editworkshift')
@include('admin.Administration.Modal.addworkshift')

<div class="h-full ml-14 mt-14 mb-5 md:ml-64">
    <div class="flex items-center justify-between mt-5 ml-2">
        <h1 class="text-2xl flex-grow">Work Shift</h1>
        <div class="flex space-x-4 items-center m-2">
        <button onclick="AddWorkShift()" class="bg-blue-500 text-white px-4 py-2 rounded-md hover:bg-blue-600 focus:outline-none">
            Add Work Shift
        </button>
        ...
        <table class="min-w-full divide-y divide-gray-200">
            <thead class="bg-gray-50">
                <tr>
                    ...
                    <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Start At</th>
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                <tr>
                    ...
                    <td class="px-6 py-4 whitespace-nowrap">8:00 AM</td>
