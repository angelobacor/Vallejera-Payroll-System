...
@endsection
@section('content')
@include('admin.requests.modal.undertimemodal')
                    ...
                    @if($leaves->count() > 0)
                        ...
                        <tr>
                            ...
                            <div class="d-flex gap-2"> <!-- Bootstrap: horizontal flex layout with spacing -->
                                <a href="{{ route('approveundertime', $leave->id) }}" class="text-success" title="Approve">
                                ...
                                <a style="margin-left:15px" href="{{ route('disapproveundertime', $leave->id) }}" class="text-danger" title="Disapprove">
