            ...
            <tbody class="bg-white divide-y divide-gray-200">
                @if($documents->count() > 0)
                    ...
                    <tr>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">    <a href="{{ route('download.document', $document->id) }}" style='color:blue'>{{ $document->name }}</a>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">{{$document->owner->name}}</td>
                ...
                @else
                <tr>
                    <td class="px-6 py-4 whitespace-nowrap" colspan="4">No Documents</td>
                </tr>
                @endif
            </tbody>
        </table>
