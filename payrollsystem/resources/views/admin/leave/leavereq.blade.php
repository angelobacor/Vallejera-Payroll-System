...
@section('content')
@include('admin.leave.Modal.assignleave') 
...
<div class="h-full ml-14 mt-14 mb-5 md:ml-64">
    ...
    <div class="flex items-center justify-between mt-5 ml-2">
        ...
        <div class="flex space-x-4 m-2">
            ...
            <div>
            <button onclick="AssignLeave(event)" data-department="{{$departments}}" class="bg-blue-500 text-white px-4 py-2 rounded-md hover:bg-blue-600 focus:outline-none">
                Assign Leave
            </button>
            </div>
        </div>
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <a href="{{route('approveleave',$leave->id)}}">Approve</a> <a href="{{route('disapproveleave',$leave->id)}}">Disapprove</a>
                            </td>
                        </tr>
                        @endforeach
                        @else
