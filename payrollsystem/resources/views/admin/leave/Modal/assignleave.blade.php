    ...
    <div class="bg-white p-6 rounded-lg shadow-lg relative w-full max-w-3xl max-h-full">
        ...
        <div class="space-y-4">
                ...
                <div class="flex-1">
                    ...
                    <select id="departmentl" onchange="fetchEmployees()" class="w-full p-2 border border-gray-300 rounded-lg focus:outline-none focus:border-blue-500" required>
                        <option value="" disabled selected>Select Department</option>
                    </select>
                </div>
                <div class="flex-1">
                    <label for="reason" class="block text-sm font-medium text-gray-700">Employee</label>
                    <select name='employee' id="employeelist" class="w-full p-2 border border-gray-300 rounded-lg focus:outline-none focus:border-blue-500" required>
