...
@section('content')
@include('payroll_officer.payroll.Modal.sendingpayslip')
@include('payroll_officer.payroll.Modal.defaultpayrun')
    ...
    @if($payrolls->count() > 0 )
        @foreach($payrolls as $payroll)
            <div class="flex items-center p-4 bg-white shadow rounded-half border mt-2 h-[170px]">
                    ...
                    <form action="{{ route('hr_sendpayslip', $payroll->id) }}"  method="Post" enctype="multipart/form-data">
                        @csrf
