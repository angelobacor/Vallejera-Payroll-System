                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    @foreach($employee_payslips as $payslip)
                        <tr>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                    <button onclick = "ViewPayslip(this)" data='{
                                ...
                                "basic_salary": "{{ $payslip->employee->salary }}",
                                "total_earning": "{{ $payslip->total_salary }}",
                                "net_salary": "{{ $payslip->net_salary }}",
                                "sss": "{{ $payslip->sss }}",
                                "pagibig": "{{ $payslip->pagibig }}",
                                "philhealth": "{{ $payslip->philhealth }}"
                            }' class="bg-gray-400 text-gray-800 px-4 py-2 rounded-md flex items-center space-x-2 hover:bg-gray-300">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <a href='{{route("hr_download", $payslip->id)}}' class="mb-2 bg-gray-400 text-gray-800 px-4 py-2 rounded-md flex items-center space-x-2 hover:bg-gray-300">
                                    ...
                                    <a href='{{route("hr_recalculate", $payslip->id)}}' class="bg-gray-400 text-gray-800 px-4 py-2 rounded-md flex items-center space-x-2 hover:bg-gray-300">
