        ...
        <div class="space-y-4">
            ...
            <div class="flex gap-4">
                ...
                <div class="flex-1">
                    ...
                    <input type="text" name='name' id="first-name" placeholder="Enter first name" class="w-full p-2 border border-gray-300 rounded-lg focus:outline-none focus:border-blue-500" />
                </div>
