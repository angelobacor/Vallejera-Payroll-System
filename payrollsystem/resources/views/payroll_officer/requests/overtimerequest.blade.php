...
@endsection
@section('content')
@include('payroll_officer.requests.modal.overtimemodal')
                    ...
                    @if($leaves->count() > 0)
                        ...
                        <tr>
                            ...
                            <div class="d-flex gap-2"> <!-- Bootstrap: horizontal flex layout with spacing -->
                                <a href="{{ route('hr_approveovertime', $leave->id) }}" class="text-success" title="Approve">
                                ...
                                <a style="margin-left:15px" href="{{ route('hr_disapproveovertime', $leave->id) }}" class="text-danger" title="Disapprove">
