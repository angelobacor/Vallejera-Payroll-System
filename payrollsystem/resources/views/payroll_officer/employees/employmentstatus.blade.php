...
@section('content')
@include('payroll_officer.modal.employeesmodal.addemploymentstat')
@include('payroll_officer.modal.employeesmodal.editemploymentstat')
<style>
    #flash-message {
        position: fixed;
        top: 20px;
...
<div class="h-full ml-14 mt-14 mb-5 md:ml-64">
    ...
    <div class="flex justify-end items-center m-2" style="margin-top:-20px;">
        <form action="{{ route('hr_employee_search') }}" method="GET" enctype="multipart/form-data" class="flex items-center space-x-2">
            @csrf
