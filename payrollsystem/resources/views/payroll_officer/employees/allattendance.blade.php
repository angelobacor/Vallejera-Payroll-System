...
@section('content')
    ...
    <div class="h-full ml-14 mt-14 mb-5 md:ml-64">
        ...
        <!-- Filters Section -->
        <div class="mt-6 mx-4 flex items-center justify-between space-x-4" style="margin-top:50px;">
            ...
            <div class="flex space-x-4 w-full items-center">
                <!-- Search Form -->
                <form action="{{ route('hr_attendance_search') }}" method="POST" enctype="multipart/form-data" class="flex items-center space-x-3">
                    @csrf
                ...
                <!-- Import Form -->
                <form action="{{ route('hr_import') }}" method="POST" enctype="multipart/form-data" class="flex items-center space-x-2" style="margin-left:25%">
                    @csrf
        ...
        <div id="attendance_div">
            @include('payroll_officer.employees.attendance_list')
        </div>
    </div>
