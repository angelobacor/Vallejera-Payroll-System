...
@endsection
@section('content')
@include('it_admin.employees.Modal.department')
@include('it_admin.employees.Modal.workshiftModal')

<div class="h-full ml-14 mt-14 mb-5 md:ml-64">
    <div class="flex items-center justify-between mt-5 ml-2">
    <h1 class="text-2xl flex-grow">Calendar</h1>
    </div>
    ...
    <div class="mt-6 ml-2 flex flex-wrap gap-2">
        ...
        @foreach (['Department', 'Workshift', 'Leave Duration', 'Users'] as $filter)
            <button 
                ...
                onclick="
                    @if ($filter === 'Department') DepartmentModal();
                    @elseif ($filter === 'Workshift') workshiftModal();
                    @endif
                "
            >
                {{ $filter }}
...
<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 m-2">
           
           <div class="relative p-6 border bg-gray-300">
               <p class="text-center text-3xl">0</p>
               <p class="font-semibold text-center">Employee on Leave</p>
           </div>
           <div class="relative p-6 border bg-gray-300">
               <p class="text-center text-3xl">0</p>
               <p class="font-semibold text-center">Total Leave Hours</p>
           </div>
           <div class="relative p-6 border bg-gray-300">
               <p class="text-center text-3xl">0</p>
               <p class="font-semibold text-center">On Leave (Single Day)</p>
           </div>
           <div class="relative p-6 border bg-gray-300">
               <p class="text-center text-3xl">0</p>
               <p class="font-semibold text-center">On Leave (Multi Day)</p>
           </div>
       </div>
