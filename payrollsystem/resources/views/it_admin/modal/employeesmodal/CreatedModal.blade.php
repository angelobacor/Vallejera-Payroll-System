<!-- Modal Structure -->
<div id="calendarModal" class="fixed inset-0 bg-gray-800 bg-opacity-50 flex items-center justify-center hidden z-50">
    <div class="bg-white p-6 rounded-lg shadow-lg relative flex flex-col w-full max-w-3xl">
        <button onclick="closeCalendarModal()" class="absolute top-2 right-2 text-gray-600 focus:outline-none">
