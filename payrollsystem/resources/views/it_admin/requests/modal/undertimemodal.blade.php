  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="undertimeForm" action="{{route('it_save_undertime')}}" method="POST">
            @csrf  
        <div class="mb-3">
          ...
          <div class="mb-3">
            <label for="startTime" class="form-label">Early-out Time</label>
            <input type="time" class="form-control" id="startTime" name="start_time" required>
          </div>

          <div class="mb-3">
            <label for="endTime" class="form-label">Duty-end Time</label>
