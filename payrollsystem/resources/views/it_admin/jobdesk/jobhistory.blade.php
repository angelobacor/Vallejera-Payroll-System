...
@endsection
@section('content')
@include('it_admin.jobdesk.Modal.departmentJH')
@include('it_admin.jobdesk.Modal.workshiftJH')
@include('it_admin.jobdesk.Modal.designationJH')
@include('it_admin.jobdesk.Modal.employementstatJH')
@include('it_admin.jobdesk.Modal.roles')
@include('it_admin.jobdesk.Modal.joiningdate')
