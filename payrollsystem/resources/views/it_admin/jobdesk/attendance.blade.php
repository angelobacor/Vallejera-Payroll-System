...
<div class="h-full ml-14 mt-14 mb-5 md:ml-64">
    ...
    <div class="m-3">
        <div class="flex justify-between items-center">
            ...
            <div class="space-x-4">
                <form action="{{route('it_filter_date_attendance')}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
...
<script>
    function exportAttendance(){
        ...
        window.location.href = "{{ route('itadmin.att.export') }}" + "?month=" + month;
    }

    function printDtr(){
        const month = document.querySelector('[name="search_month_attendance"]').value;
        window.location.href = "{{ route('itadmin.att.dtr') }}" + "?month=" + month;
    }
</script>
