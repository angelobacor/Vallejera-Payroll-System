            ...
            @if($payslip->count() > 0)
                    @foreach($payslip as $payslip)
                        <tr>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray">@if($employee->payment_method == '15 days')15 days@else Weekly @endif</td>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray">
                                <a href='{{route("download", $payslip->id)}}' class="hover:scale-110 transform transition-all">
