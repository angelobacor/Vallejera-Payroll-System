...
@endsection
@section('content')
@include('employee.jobdesk.Modal.documentsmodal')
...
<div class="h-full ml-14 mt-14 mb-5 md:ml-64">
    <div class="flex items-center justify-between mt-5 ml-2">
        ...
        <button onclick="Documents()" class="bg-blue-500 text-white px-4 py-2 rounded-md hover:bg-blue-600 focus:outline-none">
            Add New
        </button>
