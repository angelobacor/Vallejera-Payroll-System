...
@endsection
@section('content')
@include('employee.jobdesk.Modal.departmentJH')
@include('employee.jobdesk.Modal.workshiftJH')
@include('employee.jobdesk.Modal.designationJH')
@include('employee.jobdesk.Modal.employementstatJH')
@include('employee.jobdesk.Modal.roles')
@include('employee.jobdesk.Modal.joiningdate')
